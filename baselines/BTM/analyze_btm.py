...
if __name__ == "__main__":
    ...
    source_dir = os.path.join(
        project_dir, "BTM", "data", "beauty_makeupalley")
    ...
    for brand in brand_score_plots_sort:
        ...
        print("{name: 'BTM-" + brand + "', type: 'line', data: " + str(brand_score_plots_sort[brand]) + ",},")
    ...
    import csv
    with open(os.path.join(project_dir, "BTM", "data", "beauty_makeupalley", "rating_table.csv"), "w") as f:
        writer = csv.writer(f)
